  	...
  	<div class="content">
		...
		<div class="row">
			...
			<div class="card" style="width: 18rem;">
	  			<img src="${pageContext.request.contextPath}/Resources/Images/success.png" class="card-img-top" alt="Already Voted" style="height:15rem;">
		  		<div class="card-body">
		    		<h5 class="card-title">Your Voting has been  <br> casted Successfully</h5>
